...
Bem-vindo ao meu repositório de automação de processos e integração de sistemas usando **n8n**. Aqui estão documentados projetos práticos focados em eficiência operacional, manipulação de dados e integração de APIs.
...
- **Orquestração:** n8n
- **Linguagens & Formatos:** JavaScript, JSON
- **Integrações:** APIs REST, Webhooks, Google Workspace, CRMs
